...
/* El siguiente codigo se encontraba en la version original del nachos
...
void
Scheduler::SchChangePriority(Thread *thread)
{
...
void
Scheduler::SchRestorePriority(Thread *thread)
{
